...
$execute in pocket_dimension:realm positioned $(pos_x) 0.0 0.0 as @n[tag=pocket_dimension.anchor] run scoreboard players set @s pocket_dimension.id $(id)

# generate room # 0#0#0#0#0#0#0#0
$execute in pocket_dimension:realm positioned $(pos_x) 0.0 0.0 run fill ~ ~ ~ ~15 ~15 ~15 minecraft:bedrock
...
$execute in pocket_dimension:realm positioned $(pos_x) 0.0 0.0 run summon item_display ~8.0 ~8.0 ~8.0 {item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"item_model":"pocket_dimension:display","minecraft:custom_model_data":{strings:["inside"]}}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,0.5f,0.5f],scale:[7f,7f,7f]},Tags:["pocket_dimension","pocket_dimension.display","pocket_dimension.display.inside"],brightness:{sky:15,block:15}}
...
$execute in pocket_dimension:realm positioned $(pos_x) 0 0 run summon item_display ~ ~14.0 ~ {item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"item_model":"pocket_dimension:display","minecraft:custom_model_data":{strings:["teleport"]}}},Tags:["pocket_dimension","pocket_dimension.display","pocket_dimension.display.teleport"],brightness:{sky:0,block:0}}
