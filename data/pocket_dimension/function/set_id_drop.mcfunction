...
$item modify entity @s container.0 [{"function":"minecraft:set_lore","entity":"this","lore":[{translate:"pocket_dimension.belongs_to",fallback:"Belongs to %s","color":"blue","bold":false,"italic":false,"with":[{"text":"$(player_name)","bold":true}]}],"mode":"append"}]
