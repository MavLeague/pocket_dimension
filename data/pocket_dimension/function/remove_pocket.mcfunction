...
tellraw @s [{translate:pocket_dimension.message.pocket_removed,"color":"yellow"},"\n",{translate:pocket_dimension.message.pocket_removed.description,"color":"yellow",with:[{translate:pocket_dimension.message.this_command,underlined:true,color:"blue",click_event:{action:"suggest_command",command:"/function pocket_dimension:remove_pocket_display"},hover_event:{action:"show_text",value:[{translate:pocket_dimension.message.send_to_chat}]}}]}]